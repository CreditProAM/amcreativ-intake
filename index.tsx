...
const QUESTION_DEFS: Record<string, { 
    ...
    // Step 1: Discover
    'discovery.businessType': { label: "What best describes your business?", required: true, options: ['Solo Service Provider (e.g., consultant, agent)', 'Small Business / Team (2-10 people)', 'Established Brand / Firm (10+ people)', 'Startup / New Venture'] },
    'discovery.primaryChallenge': { label: "What's the biggest challenge holding you back from getting more clients?", required: true, options: ["Not enough visibility in my market", "Can't stand out from competitors", "Don't know where to start with video", "Inconsistent lead flow", "Converting views to actual meetings"] },
    ...
    'discovery.valueAnchor': { label: "What would 5-10 high-quality leads per month be worth to your business?", placeholder: "$_____ per month in additional revenue", options: [] },
  ...
  return (
    <div className="app-container">
      <header className="app-header">
        <h1>A.M. Creativ â€” Project Blueprint</h1>
        <p>This interactive brief builds the foundation for your brand's growth. Let's make you unforgettable.</p>
      </header>
                ...
                <div className="fields-grid">
                    ...
                    <Card title={QUESTION_DEFS['discovery.primaryChallenge'].label} required>
                        ...
                        <p className="micro-testimonial">
                            ...
                            <span className="quote">"I was stuck at 2-3 leads per month. After implementing strategic video content, I'm consistently getting 12-15+ qualified leads."</span>
                            <span className="author">- Sarah K., Business Owner</span>
                        </p>
                    </Card>
        ...
        {step.id === 'strategy' && (
             <section key={step.id} ref={sectionRef} tabIndex={-1} className="wizard-section">
                ...
                <div className="fields-grid md-grid-cols-2">
                    ...
                    <p className="social-proof md-col-span-2">ðŸŽ¯ Our clients see 3-5x more engagement on video content vs. static posts.</p>
                </div>
            </section>
        )}
